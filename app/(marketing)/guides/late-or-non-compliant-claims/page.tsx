  ...
  return (
    <GuideArticleView h1="Why Late or Non-Compliant Claims Cost Subcontractors Money">
      ...
      <section>
        ...
        <p className="text-[#4c739a] dark:text-slate-400 mb-2">All variations submitted should have:</p>
      ...
      <section>
        ...
        <ul className="flex flex-col gap-2 list-disc list-inside text-[#4c739a] dark:text-slate-400 mb-4">
