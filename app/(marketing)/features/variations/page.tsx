...
export const metadata: Metadata = {
  ...
  description:
    "Turn a Site Instruction into a fully-evidenced variation claim, then send it for approval with a secure link — no app, no login required."
};
...
export default function VariationsPage() {
  return (
    <FeaturePageView
      ...
      dek="Sign-off happens via a secure link — no app, no login required for the Main Contractor."
      ...
      consequence="Work gets done, nobody wrote it down properly, and three months later nobody can prove it happened — least of all when it comes to submitting a claim. That's not a missing signature, that's money left on the table."
      helps={[
        ...
        "When it's time to claim, one button — Generate Variation Package — bundles the instruction, the dayworks, the materials, the photos, and the correspondence into a single document. From there, send it for approval with a secure link — no app, no login required for the Main Contractor to act on it — no chasing a signature, no \"did they even get it.\" See Get Sign-Off Without Chasing a Signature for the full approval and automation story."
      ]}
