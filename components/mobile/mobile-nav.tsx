...
// concept of "Updates" independent of a chosen project. Incoming Emails is
// org-level, same as desktop, so it's a peer tab rather than nested under
// a project. Hidden entirely if this org doesn't have the module enabled
// for this user — same gate desktop's TopNav applies.
export function MobileNav({ canSeeIncomingEmails }: { canSeeIncomingEmails: boolean }) {
  ...
  if (!canSeeIncomingEmails) return null;
