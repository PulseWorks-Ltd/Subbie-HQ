...
// and the banner is only suppressed for two weeks before re-offering. Even
// while snoozed, InstallAppButton (in the header) stays reachable — this
// banner dismissing is no longer the only way to find install instructions.
