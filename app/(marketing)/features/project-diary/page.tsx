...
export default function ProjectDiaryPage() {
  return (
    <FeaturePageView
      ...
      consequence="So it doesn't get done — or it gets done badly, from memory, days later. No continuous record of what happened, when. A client left wondering what's going on. And a habit that starts strong on day one of the job and quietly stops by week three."
      helps={[
